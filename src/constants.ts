...
export const GIFTS_CATALOG: GiftDefinition[] = [
  ...
  },
  {
    ...
    apples: 10,
    tier: 'medium',
    description: '+10 maçãs na arena',
  },
  { id:'finger_heart', name:'Finger Heart', icon:'🫰', apples:4, eventTrigger:'double', tier:'small', description:'+4 maçãs + 2x temporário' },
  { id:'perfume', name:'Perfume', icon:'🧴', apples:7, eventTrigger:'super_growth', tier:'medium', description:'+7 maçãs + Super Crescimento' },
  { id:'confetti', name:'Confete', icon:'🎊', apples:8, eventTrigger:'rain', tier:'special', description:'+8 maçãs + Chuva Festiva' },
  { id:'rocket', name:'Foguete', icon:'🚀', apples:18, eventTrigger:'turbo', tier:'special', description:'+18 maçãs + Turbo' },
  { id:'lion', name:'Leão', icon:'🦁', apples:25, eventTrigger:'treasure', tier:'large', description:'+25 maçãs + Caça ao Tesouro' },
  {
    id: 'galaxy',
    name: 'Galáxia',
    icon: '🌌',
    ...
    tier: 'large',
    description: '+35 maçãs + Evento Cósmico',
  },
  {
    id: 'lightning',
    name: 'Raio',
